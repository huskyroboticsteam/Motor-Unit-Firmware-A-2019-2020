...
void CAN_ReceiveMsg(uint8 rxMailbox) 
{
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgGeneral_0
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgGeneral_0(void) 
    {
        /* `#START MESSAGE_General_0_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_General_0_CALLBACK
            CAN_ReceiveMsg_General_0_Callback();
        #endif /* CAN_RECEIVE_MSG_General_0_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgGeneral_1
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgGeneral_1(void) 
    {
        /* `#START MESSAGE_General_1_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_General_1_CALLBACK
            CAN_ReceiveMsg_General_1_Callback();
        #endif /* CAN_RECEIVE_MSG_General_1_CALLBACK */
